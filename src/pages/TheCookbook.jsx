            ...
            <div className="flex flex-col items-center bg-brown-dark">
                <div className="md:w-6/12 justify-center">
                    ...
                    <div>
                        ...
                        <ParagraphComponent>
                            Marika, här får Du ett tecken till att ignorera. Den har, liksom den riktiga konsten, sitt eget starka uttryck. Alltså beror det på mottagaren att uttolka det, inget mer. Släng den i Din soptunna. Mamma
                        </ParagraphComponent>
                    </div>
                    <div>
                        <SubHeadingComponent>ENG</SubHeadingComponent>
                        <ParagraphComponent>
                            Marika, here you get a sign to ignore. It has, like real art, its own strong expression. Therefore it's up to the recipient to interpret it, nothing more. Throw it in your trash bin. Mom
                        </ParagraphComponent>
                    </div>
                    <div>
                        <SubHeadingComponent>DE</SubHeadingComponent>
                        <ParagraphComponent>
                            Marika, hier bekommst du ein Zeichen, das du zu ignorieren kannst. Es hat, wie die richtigen Künste, seinen eigenen starken Ausdruck gefunden. Also hängt es von dem/der Empfänger*in ab, es zu interpretieren, nichts Weiteres. Wirf es in deine Mülltonne. Mama
                        </ParagraphComponent>
                    </div>
                </div>
            </div>
